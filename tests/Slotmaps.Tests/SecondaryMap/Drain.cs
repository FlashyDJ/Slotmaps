...
public class Drain
{
    ...
    public void RemovedKeysWithTimeSpan_NotReturnRemovedKeys()
    {
        ...
        secondaryMap.Insert(key4, new(03,00,00));
    ...
    public void DrainingUpToMiddleWithTimeSpan_ReturnsItemsAndEmptiesMap()
    {
        ...
        secondaryMap.Insert(key3, new(02,00,00));
        secondaryMap.Insert(key4, new(03,00,00));
        secondaryMap.Insert(key5, new(04,00,00));
        secondaryMap.Insert(key6, new(05,00,00));
        ...
        Assert.Contains(new KeyValuePair<SlotKey, TimeSpan>(key3, new(02,00,00)), drainedItems);
        Assert.Equal(3, drainedItems.Count);
        Assert.Contains(new KeyValuePair<SlotKey, TimeSpan>(key4, new(03,00,00)), secondaryMap);
        Assert.Contains(new KeyValuePair<SlotKey, TimeSpan>(key5, new(04,00,00)), secondaryMap);
        Assert.Contains(new KeyValuePair<SlotKey, TimeSpan>(key6, new(05,00,00)), secondaryMap);
        Assert.Equal(3, secondaryMap.Count);
    }
    ...
    public void RemovedKeysWithTimeSpanNullable_NotReturnRemovedKeys()
    {
        ...
        secondaryMap.Insert(key4, new(02,00,00));
    ...
    public void DrainingUpToMiddleWithTimeSpanNullable_ReturnsItemsAndEmptiesMap()
    {
        ...
        secondaryMap.Insert(key3, new(01,00,00));
        secondaryMap.Insert(key4, new(02,00,00));
        secondaryMap.Insert(key5, new(03,00,00));
        secondaryMap.Insert(key6, new(04,00,00));
        ...
        Assert.Contains(new KeyValuePair<SlotKey, TimeSpan?>(key3, new(01,00,00)), drainedItems);
        Assert.Equal(3, drainedItems.Count);
        Assert.Contains(new KeyValuePair<SlotKey, TimeSpan?>(key4, new(02,00,00)), secondaryMap);
        Assert.Contains(new KeyValuePair<SlotKey, TimeSpan?>(key5, new(03,00,00)), secondaryMap);
        Assert.Contains(new KeyValuePair<SlotKey, TimeSpan?>(key6, new(04,00,00)), secondaryMap);
        Assert.Equal(3, secondaryMap.Count);
    }
