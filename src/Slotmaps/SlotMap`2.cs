...
public class SlotMap<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable
    where TKey : struct, ISlotKey<TKey>
{
    ...
    /// <summary>
    ///   Gets a reference to the value associated with the specified key in the slot map.
